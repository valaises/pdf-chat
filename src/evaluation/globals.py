...
#
# CHAT_MODEL = os.environ.get("EVAL_CHAT_MODEL")
# assert CHAT_MODEL
#
# CHAT_EVAL_MODEL = os.environ.get("EVAL_CHAT_EVAL_MODEL")
# assert CHAT_EVAL_MODEL
#
# CHAT_ANALYSE_MODEL = os.environ.get("EVAL_CHAT_ANALYSE_MODEL")
# assert CHAT_ANALYSE_MODEL
